...
void main() {
  group('DebtReminder', () {
    ...
    test('completed getter returns true when isCompleted=1', () {
      final r = DebtReminder(customerId: 'c1', reminderDate: '2025-01-01', isCompleted: 1);
    ...
    test('toString contains key fields', () {
      final r = DebtReminder(id: 'uuid-3', customerId: 'c1', debtId: 'd2', reminderDate: '2025-05-05');
      final s = r.toString();
