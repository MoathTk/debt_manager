...
import 'package:local_debt_management/features/debts/domain/entities/transaction.dart'
    as model;
import 'package:local_debt_management/features/debts/presentation/widgets/transaction_search_bar.dart';
import 'package:local_debt_management/features/debts/presentation/widgets/transaction_filter_bar.dart';
import 'package:local_debt_management/features/debts/presentation/widgets/sort_bottom_sheet.dart';
import 'package:local_debt_management/features/debts/presentation/widgets/all_transactions_tile.dart';
                    ...
                    builder: (context) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (_, i) => AllTransactionsTile(
                          transaction: f[i],
                          remaining: f[i].isDebt ? remainingMap[f[i].id] : null,
                        ),
                      );
                    },
                  ),
